...
class PrismaticForConditionalGeneration(PrismaticPreTrainedModel):
    ...
    def forward(
        ...
        # === Handle Multimodal Forward ===
            ...
            projected_patch_embeddings = self.projector(patch_features) # [batch,256,2176] -> [batch,256,4096]
            ...
            input_embeddings = self.get_input_embeddings()(input_ids) #[batch, seq_len] -> [batch, sqeuence_len, embed_dim(4096)]
