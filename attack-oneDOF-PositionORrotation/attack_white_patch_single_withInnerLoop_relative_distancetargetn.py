...
def main(args):
    ...
    from  openvla_attacker_untarget_withInnerLoop_relative_distancetarget import OpenVLAAttacker
    ...
    openVLA_Attacker = OpenVLAAttacker(vla, processor, path,optimizer="adamW", resize_patch=args.resize_patch,alpha=0,belta=0.2)
...
def arg_parser():
    ...
    parser.add_argument('--tags',nargs='+', default=["untargetDirection","alpha0beta02"])
