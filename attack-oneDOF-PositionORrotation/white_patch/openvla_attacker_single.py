...
class OpenVLAAttacker(object):
    ...
    def patchattack_unconstrained(self,train_dataloader,val_dataloader,num_iter=5000,target_action=np.zeros(7),patch_size=[3,50,50],alpha=1/255, accumulate_steps=1,maskidx=[],warmup=20,filterGripTrainTo1=False,geometry=False, colorjitter=False):
        self.val_CE_loss = []
        self.val_L1_loss = []
        self.val_ASR = []
        self.train_CE_loss = []
