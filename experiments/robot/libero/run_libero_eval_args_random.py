...
def parse_args():
    ...
    parser.add_argument("--exp_name", type=str, default="random_noise", help="Model family")
    ...
    # Utils
    #################################################################################################################
    parser.add_argument("--run_id_note", type=str, default="random_noise", help="Extra note to add in run ID for logging")
    ...
    parser.add_argument("--wandb_project", type=str, default="LIBERO", help="Name of W&B project to log to (use default!)")
