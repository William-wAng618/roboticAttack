...
def parse_args():
    ...
    parser.add_argument("--exp_name", type=str, default="adv_DoF1_noTras", help="Model family")
    ...
    # Utils
    #################################################################################################################
    parser.add_argument("--run_id_note", type=str, default="spatial1", help="Extra note to add in run ID for logging")
    ...
    parser.add_argument("--wandb_project", type=str, default="YOUR_WANDB_PROJECT", help="Name of W&B project to log to (use default!)")
    parser.add_argument("--wandb_entity", type=str, default="YOUR_WANDB_ENTITY", help="Name of entity to log under")
