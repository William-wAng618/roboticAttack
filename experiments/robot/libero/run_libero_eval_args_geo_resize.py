...
def eval_libero(cfg) -> None:
    ...
    patch_path = "/spl_data/tw9146/openvla-main/run/white_patch_attack/eeb5e6a3-f601-4744-aa1d-0f4611804143/4500/patch.pt"
        ...
        for episode_idx in tqdm.tqdm(range(cfg.num_trials_per_task)):
            ...
            while t < max_steps + cfg.num_steps_wait:
                try:
                    ...
                    # img = randomPatchTransform.simulation_random_patch(img, patch, geometry=True,colorjitter=False, angle=10, shx=-0.13, shy=-0.1)
                    img = randomPatchTransform.simulation_random_patch_resize(np.asarray(img), patch, geometry=True,colorjitter=False,angle=35,shx=-0.15,shy=-0.1)
...
def parse_args():
    ...
    parser.add_argument("--exp_name", type=str, default="adv_DoF1_Tras_resize", help="Model family")
    parser.add_argument("--pretrained_checkpoint", type=str, default="openvla/openvla-7b-finetuned-libero-spatial", help="Pretrained checkpoint path")
    ...
    # LIBERO environment-specific parameters
    #################################################################################################################
    parser.add_argument("--task_suite_name", type=str, default="libero_spatial", help="Task suite. Options: libero_spatial, libero_object, libero_goal, libero_10, libero_90")
    ...
    # Utils
    #################################################################################################################
    parser.add_argument("--run_id_note", type=str, default="geo_adv_resize", help="Extra note to add in run ID for logging")
    ...
    parser.add_argument("--wandb_project", type=str, default="LIBERO-resize", help="Name of W&B project to log to (use default!)")
