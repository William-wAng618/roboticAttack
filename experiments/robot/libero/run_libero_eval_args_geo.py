...
def eval_libero(cfg) -> None:
    ...
    patch_path = "/spl_data/tw9146/openvla-main/run/white_patch_attack/fd4f32d7-ea1b-4635-a429-b03afca1bdb6/500/patch.pt"
    patch = torch.load(args.patchroot)
    # Set random seed
...
def parse_args():
    ...
    exp_id ="4000-a5083c2b-1186-4464-ab9f-1056211a2221"
    #################################################################################################################
    # Model-specific parameters
    #################################################################################################################
    parser.add_argument("--model_family", type=str, default="openvla", help="Model family")
    parser.add_argument("--exp_name", type=str, default=f"libero_spatial_{exp_id}", help="Model family")
    ...
    # Utils
    #################################################################################################################
    parser.add_argument("--run_id_note", type=str, default=f"libero_spatial_{exp_id}", help="Extra note to add in run ID for logging")
