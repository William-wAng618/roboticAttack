...
colorjitter=ture
maskidx='6'
tags="LRDecay WarmUp single DoF7 colorjitter+geometry"
filterGripTrainTo1=false
# Load parameters from config.json
config_file="openvla-main/attack-oneDOF-PositionORrotation/batch_run/exp1/config.json"
...
python openvla-main/attack-oneDOF-PositionORrotation/attack_white_patch.py \
    --lr $lr \
    --maskidx $maskidx \
    --server $server \
    --device $device \
